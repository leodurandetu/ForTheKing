...
Le menu est essentiel dans l’expérience utilisateur. Il a été implémenté avec la bibliothèque SDL2, qui permet de gérer les événements (clics, clavier) ainsi que le rendu graphique des éléments interactifs. Cette approche assure une navigation fluide et intéractive.
