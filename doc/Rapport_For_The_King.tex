...
La phase de conception permet de réfléchir sur, comment le jeu sera construit avant de coder. L'idée principale est de créer un système composé de plusieurs parties qui fonctionnent de manière indépendante, c'est-à-dire, chaque élément du jeu, comme la carte, les combats et l'interface utilisateur, peut être développé et testé séparément sans affecter les autres parties du jeu. Cette façon de réflexion est basée sur trois principes simples :
